...
export var fileStatsHandler = new SimpleHandlerBuilder(
config => {
...
export var fileStatsMiddleware = new PrivateInputMiddleware(
  fileStatsHandler, 'getFileStats')

export var fileStatsFilter = new ArgsBuilderFilter(
config => {
