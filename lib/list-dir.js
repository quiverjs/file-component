...
export var listDirPathHandler = simpleHandlerBuilder(
config => {
...
export var listDirMiddleware = privateInputMiddleware(
  listDirPathHandler, 'listDirHandler', { loader: loadStreamHandler })